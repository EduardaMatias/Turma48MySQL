...
VALUE("Cleison", "Anão", 1500, 3000, 12000, 1);

INSERT INTO tb_personagem(nome, raca, vida, defesa, ataque, classe_id)
VALUE("Josias", "Elfo negro", 1000, 1200, 3000, 5);

INSERT INTO tb_personagem(nome, raca, vida, defesa, ataque, classe_id)
VALUE("Vanuza", "Centauro", 5000, 700, 7500, 2);

INSERT INTO tb_personagem(nome, raca, vida, defesa, ataque, classe_id)
VALUE("Cleide", "Humana", 500, 6000, 2000, 3);

INSERT INTO tb_personagem(nome, raca, vida, defesa, ataque, classe_id)
VALUE("Ariel", "Construto", 2000, 8800, 4000, 4);

INSERT INTO tb_personagem(nome, raca, vida, defesa, ataque, classe_id)
VALUE("Anitta", "Elfa", 2500, 6000, 8000, 3);
